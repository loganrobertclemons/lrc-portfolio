  ...
  render() {
    return (
      <div className="skills">
        ...
        <div className="title">
          <h3>Skills</h3>
          <p>Here is where I think my skills are right now.
            I have probably overestimated myself in some things,
            and underestimated myself in others.
            Judging yourself is hard!
          </p>
        </div>
